...
def main():
  ...
  if (1<=a<=31) and (b=="Januray" or b=="February" or b=="March" or b=="April" or b=="May" or b=="June" or b=="July" or b=="August" or b=="September" or b=="October" or b=="November" or b=="December":
